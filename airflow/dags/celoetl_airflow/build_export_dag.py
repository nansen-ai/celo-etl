...
from celoetl_airflow.gcs_utils import upload_to_gcs, download_from_gcs

from celoetl.cli import (
...
def build_export_dag(
        ...
        export_max_not_monotonic_blocks=10,
        export_rate_limit=None,
        trace_export_batch_size=None,
    ...
    if trace_export_batch_size is None:
        trace_export_batch_size = export_batch_size
    ...
    def copy_from_export_path(export_path, file_path):
        ...
        download_from_gcs(bucket=output_bucket, object=export_path + filename, filename=file_path, gzip=use_gzip)
    ...
    def get_block_range(tempdir, date, provider_uri):
        ...
        get_block_range_for_date.callback(
            ...
            max_not_monotonic_blocks=export_max_not_monotonic_blocks,
        )
    ...
    def export_traces_command(execution_date, provider_uri, **kwargs):
        with TemporaryDirectory() as tempdir:
            ...
            logging.info('Calling export_geth_traces({}, {}, {}, ...,{}, {})'.format(
                start_block, end_block, trace_export_batch_size, export_max_workers, provider_uri,
            ))
            if not export_traces_from_gcs:
                export_geth_traces.callback(
                    start_block=start_block,
                    end_block=end_block,
                    batch_size=trace_export_batch_size,
