...
def build_partition_dag(
    ...
    dag = models.DAG(
        dag_id,
        start_date=datetime.strptime('2021-08-29', '%Y-%m-%d'),
        catchup=False,
        schedule_interval=schedule_interval,
        default_args=default_dag_args)

    bigquery_client = bigquery.Client()
    dataset = create_dataset(bigquery_client, partitioned_dataset_name, partitioned_project_id)
    ...
    wait_for_load_dag_task = ExternalTaskSensor(
    ...
    wait_for_load_dag_task >> partition_logs_task
