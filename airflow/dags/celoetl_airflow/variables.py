...
def read_export_dag_vars(var_prefix, **kwargs):
    ...
    export_max_not_monotonic_blocks = read_var('export_max_not_monotonic_blocks', var_prefix, False, **kwargs)
    export_max_not_monotonic_blocks = int(export_max_not_monotonic_blocks) if export_max_not_monotonic_blocks is not None else 10
    ...
    vars = {
        ...
        'export_max_not_monotonic_blocks': export_max_not_monotonic_blocks,
...
def read_load_dag_vars(var_prefix, **kwargs):
    ...
    vars = {
        ...
        'load_all_partitions': parse_bool(read_var('load_all_partitions', var_prefix, False, **kwargs), default=False),
    }
