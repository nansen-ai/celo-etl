...
from celoetl_airflow.bigquery_utils import submit_bigquery_job, read_bigquery_schema_from_json_recursive, query, \
    create_view, does_table_exist
from celoetl_airflow.parse.templates import render_parse_udf_template, render_parse_sql_template, \
...
def parse(
    ...
    dataset_name = f'{chain_name}_' + table_definition['table']['dataset_name']
